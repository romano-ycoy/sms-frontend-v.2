    ...
    <Card className="rounded-none shadow-none flex justify-center h-full w-full p-4 bg-card">
      ...
      <CardContent>
        <form className="space-y-5" onSubmit={handleSubmit}>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input
                ...
                className={`pr-10 lg:h-10 ${errors.email ? "border-red-500 focus-visible:ring-red-500" : ""
                  }`}
              />
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input
                ...
                className={`pr-10 lg:h-10 ${errors.password ? "border-red-500 focus-visible:ring-red-500" : ""
                  }`}
              />
              <button
                type="button"
          ...
          {/* Submit Button */}
          <Button
            className={`w-full bg-emerald-500 hover:bg-emerald-700 mt-2 lg:text-md ${loading ? "cursor-not-allowed" : "cursor-pointer"
              }`}
            type="submit"
            disabled={loading}
          >
